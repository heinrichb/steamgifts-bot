...
If Windows SmartScreen warns you:
  - Click "More info"
  - Click "Run anyway"
  This happens because the binary isn't yet code-signed (see TODO.md).

To uninstall:
  - If you installed it as a background service, run:
      steamgifts-bot service uninstall
  - Then delete the folder.

Need help?
  https://github.com/heinrichb/steamgifts-bot
